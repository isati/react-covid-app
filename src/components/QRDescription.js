...
const QRDescription = () => (
  <div className="qrReaderDescription">
    <div className="descriptionText">
      ...
      <p>
        Hold your phone so that the official NHS QR code appears in the box
        above. When your phone recognises the QR code, it will show that you
        have successfully checked in.
      </p>
    </div>
  </div>
);
